...
import 'package:ride/Services/todo-item.dart';
import 'package:ride/Services/db.dart';
void main() async {
                  ...
                  child: FlatButton(
                      child: Row(
                          ...
                          children: <Widget>[
                              ...
                              Icon(item.complete == true ? Icons.radio_button_checked : Icons.radio_button_unchecked, color: Colors.yellow)
                          ]
                      ),
